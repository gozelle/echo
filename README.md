...
[![GoDoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://pkg.go.dev/github.com/gozelle/echo)
...
Any of these versions will allow you to import Echo as `github.com/gozelle/echo` which is the recommended
...
go get github.com/gozelle/echo
```
...
import (
  ...
  "github.com/gozelle/echo/middleware"
  "net/http"
)
